...
rm -rf ./ULTRAINTERFACE/Package/contentFiles/any/any/resources/*
rm -rf ./ULTRAINTERFACE/Package/contentFiles/any/any/src/*
...
cp /ssd/Unity/Projects/ULTRAINTERFACE/Assets/StreamingAssets/ultrainterface ./ULTRAINTERFACE/resources/
